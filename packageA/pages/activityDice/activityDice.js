    ...
    if (res.from === 'button') {
      if (res.target.id == 'getRelive' || res.target.id == 'getRelive2') {
        ...
        return {
          ...
          path: '/packageA/pages/activityDiceHelp/activityDiceHelp?ordersId=' + this.data.ordersId + '&shareUserId=' + this.data.shareUserId,
          imageUrl: this.data.sharePic
        }
      } else {
        return {
          title: '摇骰子赢好礼，速来PK！',
          path: '/packageA/pages/activityDice/activityDice?ordersId=' + this.data.ordersId,
