// pages/activityPintuHelp/activityPintuHelp.js
const app = getApp()
...
Page({
  ...
  getCanAssistant: function () {
    wx.request({
      url: config.config.getCanAssistantActivityPintu,
      data: {
        token: this.data.token,
        ordersId: this.data.ordersId,
  ...
  assistant: function () {
    wx.request({
      url: config.config.addAssistantActivityPIntu,
      data: {
        token: this.data.token,
        ordersId: this.data.ordersId,
        shareUserId: this.data.shareUserId
  ...
  onShow: function () {
    ...
    wx.getStorage({
      ...
      success: (res) => {
        ...
        // console.log("是否显示主力框" + this.data.isShowAssis)
      },
      fail: (res) => {
        this.setData({
          token: 'paixi_123'
  ...
  onShareAppMessage: function (res) {
    if (res.from === 'button') {
      ...
      return {
        ...
        path: '/packageA/pages/activityPintuHelp/activityPintuHelp?ordersId=' + this.data.ordersId + '&shareUserId=' + this.data.userId,
        imageUrl: this.data.sharePic
      }
    }
    return {
      title: '拼图赢奖品，就等你来玩！',
      path: '/packageA/pages/activityPintu/activityPintu?ordersId=' + this.data.ordersId,
